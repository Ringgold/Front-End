...
//	console.log(checkBox[2].getBoundingClientRect().left);
}
function Handlers() {
...
function buildTypeBar() {
	...
	//
	var column11 = new mui.PopPicker();
	column11.setData([
		{
            value: '0',
            text: 'Eleven 1'
...
function initTable(site_id) {
	...
	for(i=0; i<checkBox.length; i++) {checkBox[i].style.backgroundColor = 'rgb(255, 255, 255)';}
